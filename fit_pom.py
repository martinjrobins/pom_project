filename = 'data/AMBOxford/GC_1.0M_H2SO4_done/60Hz20mV104mVs1.0M_SFRGC__all_k_lower_33-0-45/POMGCL_6020104_1.0M_SFR_d16.txt'
...
prior.add_parameter('E01',hobo.Normal(0.35,0.05),model.params['Estart']+e0_buffer,model.params['Ereverse']-e0_buffer)
prior.add_parameter('E02',hobo.Normal(0.35,0.05),model.params['Estart']+e0_buffer,model.params['Ereverse']-e0_buffer)
prior.add_parameter('E11',hobo.Normal(0.227,0.05),model.params['Estart']+e0_buffer,model.params['Ereverse']-e0_buffer)
prior.add_parameter('E12',hobo.Normal(0.227,0.05),model.params['Estart']+e0_buffer,model.params['Ereverse']-e0_buffer)
prior.add_parameter('E21',hobo.Normal(0.0,0.05),model.params['Estart']+e0_buffer,model.params['Ereverse']-e0_buffer)
prior.add_parameter('E22',hobo.Normal(0.0,0.05),model.params['Estart']+e0_buffer,model.params['Ereverse']-e0_buffer)
