...
\begin{figure}[h]
\includegraphics[width=\textwidth]{images/quasireversible.pdf}
...
\begin{figure}[h]
\includegraphics[width=\textwidth]{images/quasireversible_best.pdf}
    ...
    reductions process of \ce{[PMo12O40]3-} adsorbed on a GC in contact with
    1.0 M \ce{H2SO4}. AC experimental data obtained with $f = 60$ Hz, $\Delta E
...
\begin{figure}[h]
\includegraphics[width=\textwidth]{images/reversible.pdf}
    \caption{\it{Results of automated fitting of model to experimental data
